...
Решения оцениваются по метрике **ROC-AUC* *- площадь под кривой ошибок. Эта метрика хорошо подходит для задач с несбалансированными классами, так как оценивает способность модели ранжировать положительные примеры выше отрицательных.
